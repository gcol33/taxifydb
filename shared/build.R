...
#
# Takes a precomputed data.frame and writes the final .vtr file with
# genus-sorted rows, hash indexes, and metadata sidecar.

#' Write a backbone .vtr file from a precomputed data.frame
#'
#' Sorts by genus (for zone-map pruning), writes .vtr, creates hash indexes,
